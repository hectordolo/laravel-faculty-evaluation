...
@section('page-content')
    ...
    <div class="col-md-4 col-sm-4 col-xs-12 form-group pull-right top_search">
        {!! Form::open(['method' => 'GET', 'route' => 'employees.search']) !!}
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    @foreach($employees as $key=>$employee)
                        <tr>
                            ...
                            <td>
                                <a type="button" class="btn btn-default btn-sm" title="Delete Question" data-toggle="modal" data-target="#deleteModal{{ $employee->id }}"><i class="fa fa-trash"></i></a>
                                <div id="deleteModal{{ $employee->id }}" class="modal fade" role="dialog">
