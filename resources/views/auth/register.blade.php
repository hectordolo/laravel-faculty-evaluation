                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('school_code') ? ' has-error' : '' }}">
                            <label for="school_code" class="col-md-4 control-label">School Code</label>

                            <div class="col-md-6">
                                <input id="school_code" type="text" class="form-control" name="school_code" value="{{ old('school_code') }}" required autofocus>
